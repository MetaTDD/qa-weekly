...
image::img/info.png[信息,align="center"]  
...
image::img/quit_vim.jpg[退出Vim,align="center"]  

* JS的比较结果

image::img/js_assert.jpg[JS的比较结果,align="center"]  

* Java图书阅读路径

image::img/java_path.jpg[Java读书路径,align="center"]  
